...
export const baseUrl = "https://docs.google.com/forms/d/e/1FAIpQLSc0n27dpw5ewId4ugkesc8QpjF1on29ThxcU776kA53ayrkvQ/viewform";

export function buildGoogleFormUrl(data: FormField[]): string {
  const params = data
